...
The final project of the Udacity "Self-Driving Car Engineer" course is a team code completion exercise in which the objective is to program a real car to drive autonomously around a simple test track. This is achieved by writing Robot Operating System (ROS) nodes for path planning and drive by wire (DBW) control and implementing a traffic light classifier by training a neural network. 

A simulator was used for testing during development. To run the program with the simulator, see "SETUP.md" for full installation instructions.

The project was completed by a team consisting of 5 members: Chang, Joydeep, Kenneth, Mahmoud, Srinivasan.
...
This section provides a general overview of autonomous vehicle architecture and explains the architecture implemented in this project.
